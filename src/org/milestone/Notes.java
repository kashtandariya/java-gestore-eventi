...
1. Creare una classe Evento che abbia le seguenti proprietà:
...
2. Inserire il controllo che la data non sia già passata e che il numero di posti totali sia positivo. 
--> In caso contrario mostrare i dovuti avvisi all’utente 

3 Aggiungere metodi getter e setter in modo che:
- titolo/data sia in lettura e in scrittura 
- numero di posti totale e prenotati siano solo in lettura 

4. Vanno inoltre implementati dei metodi public che svolgono le seguenti funzioni: 
